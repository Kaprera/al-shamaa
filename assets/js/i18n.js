...
(function () {
  ...
  var AR = {
    ...
    "Advanced Building Information Modelling that carries real construction geometry — so conflicts are resolved in the model, not on the slab.": "نمذجة متقدّمة لمعلومات البناء تحمل هندسة التنفيذ الفعلية — لتُحَلّ التعارضات داخل النموذج لا على البلاطة.",
    "3D Modeling & Shop Drawings": "النمذجة ثلاثية الأبعاد والمخططات التنفيذية",
    "Clash Detection & Multi-Disciplinary Coordination": "كشف التعارضات والتنسيق بين التخصصات",
    "BIM Management & Standards Consulting": "إدارة BIM والاستشارات في المعايير",
    "As-Built Modeling": "نمذجة «كما نُفِّذ»",
    "Design": "التصميم",
    ...
    "Phase 04": "المرحلة الرابعة",
    "Damour · Chouf, Lebanon": "الدامور · الشوف، لبنان",
    "A private villa development where the structure is the architecture: raked reinforced-concrete columns carry the upper floor and the cantilevered roof, so almost nothing about the reinforcement repeats. We modelled the ground-floor-to-first-floor columns in full 3D, worked out the bar arrangement where each inclined shaft lands in a 40 cm slab, and issued a coordinated set of elevations, plans and bar bending schedules.": "مشروع فلل خاصة يكون فيه الهيكل هو العمارة نفسها: أعمدة خرسانية مائلة تحمل الطابق العلوي والسقف الكابولي، فلا يكاد شيء في التسليح يتكرّر. نمذجنا أعمدة الطابق الأرضي حتى الأول ثلاثية الأبعاد بالكامل، وحسمنا ترتيب الأسياخ عند التقاء كل عمود مائل ببلاطة سماكتها 40 سم، وأصدرنا حزمة منسّقة من المساقط والمقاطع وجداول ثني الحديد.",
    "Scope": "النطاق",
    "Reinforcement shop drawings & BBS": "مخططات تنفيذية لحديد التسليح وجداول الثني",
    "Elements": "العناصر",
    "Inclined columns, 40 cm flat slabs, footings": "أعمدة مائلة، بلاطات مسطّحة 40 سم، قواعد",
    "Method": "الأسلوب",
    "3D rebar model → model-driven drawings": "نموذج حديد ثلاثي الأبعاد ← مخططات مستخرجة منه",
    "Package": "الحزمة",
    "Ground floor to first floor": "من الطابق الأرضي إلى الأول",
    "Status": "الحالة",
    "Issued for approval": "صادرة للاعتماد",
    ...
    "Sheets reproduced from the issued package with the title block removed.": "لوحات من الحزمة الصادرة، أُزيل منها بلوك العنوان.",
